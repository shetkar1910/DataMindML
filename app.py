...
st.set_page_config(page_title="DataMindML" ,page_icon="favicon.png")
...
st.markdown(
    ...
    <div class="container">
        ...
        <p class="logo-text"> DataMindML Workspace</p><br>
    </div>
...
if __name__=="__main__":
    ...
    st.sidebar.subheader("Unleash the Power of Data with DataMineML...📈📉📊")     
    ...
    st.sidebar.markdown(btndf('LinkedIn','https://www.linkedin.com/in/saksham-shetkar/'),unsafe_allow_html=True)



    if data_tool_level1 and tmp_csv!=False:
        #st.subheader("Data Tool")
        check1=st.expander("Data Processing and  Cleaning Tools:",expanded=True)
    ...
    if data_tool_level2 and tmp_csv!=False:
        check2=st.expander("Exploratory Data Analysis :",expanded=True)
    ...
    model_detail=st.expander("Documentation")
    ...
    try:
        ...
        if choose_algo and tmp_csv==False:
            ...
            # check3=st.expander("Model Validation :",expanded=True)       
            ...
            if choose_algo==supervised_models_list[1] and (dep and tar!=" ") :
                ...
                linear_reg_para=st.expander("Model Parameters")
            ...
            #Logistic Regression
                ...
                logistic_reg_para=st.expander("Model Parameters")
            ...
            #Knn
                ...
                knn_para=st.expander("Model Parameters")
            ...
            #decision tree classifier
                ...
                dtc_para=st.expander("Model Parameters")                
            ...
            #support vector machine classifier
                ...
                svc_para=st.expander("Model Parameters")
            ...
            #kmeans clustering
                ...
                kmc_para=st.expander("Model Parameters")
            ...
            #principal component analysis
                ...
                pca_para=st.expander("Model Parameters")
